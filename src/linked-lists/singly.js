...
export class SinglyLinkedList {
    ...
    removeAt(index) {
        ...
        currentNode.next = currentNode.next.nodeBeforeIndexToBeInsertedAt
...
``
    ...
    removeLast() {
        ...
        //This loop stops at the last node as current.next as current.next will be null for the tail
