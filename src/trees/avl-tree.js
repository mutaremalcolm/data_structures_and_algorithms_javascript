...
export class AVLTree {
    ...
    balanceAndRotate(currentNode) {
        ...
        if (balanceFactor > 1) {
            // If balance factor is less than 0 for left child, then it is a LR imbalance
            ...
            // It that is the case, before doing the right rotation,
            ...
            // we need to do a left rotation on the right child
            // Because the left child is skewed towards the right
