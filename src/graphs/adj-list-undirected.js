export class AdjListUndirected {
    ...
    addEdge(vertex1, vertex2) {
        ...
        const edgesForVertext2 = this.list.get(vertex2)

        const newEdgesForVertex1 = [...edgesForVertex1, vertex2]
        const newEdgesForVertex2 = [...edgesForVertext2, vertex1]
    ...
    hasEdge(vertex1, vertex2) {
        ...
        const isVertex1InVertex2Edges = edgesForVertext2.includes(vertex1)
    ...
    removeEdge(vertex1, vertex2) {
        ...
        const newEdgesForVertex2 = edgesForVertext2.filter(
            (edge) => edge !== vertex1
        )
